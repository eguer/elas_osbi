...
edge_call_args_ptr(struct edge_call* edge_call, uintptr_t* ptr, size_t* size, struct shared_region *shared_region) {
  *size = edge_call->call_arg_size;
  return edge_call_get_ptr_from_offset(edge_call->call_arg_offset, *size, ptr, shared_region);
}
...
edge_call_ret_ptr(struct edge_call* edge_call, uintptr_t* ptr, size_t* size, struct shared_region *shared_region) {
  *size = edge_call->return_data.call_ret_size;
  return edge_call_get_ptr_from_offset(
      edge_call->return_data.call_ret_offset, *size, ptr, shared_region);
}
...
edge_call_setup_call(struct edge_call* edge_call, void* ptr, size_t size, struct shared_region *shared_region) {
  ...
  return edge_call_get_offset_from_ptr(
      (uintptr_t)ptr, size, &edge_call->call_arg_offset, shared_region);
}
...
edge_call_setup_ret(struct edge_call* edge_call, void* ptr, size_t size, struct shared_region *shared_region) {
  ...
  return edge_call_get_offset_from_ptr(
      (uintptr_t)ptr, size, &edge_call->return_data.call_ret_offset, shared_region);
}
...
edge_call_setup_wrapped_ret(
  ...
  edge_call_get_offset_from_ptr(
      shared_region->shared_start + sizeof(struct edge_call) + sizeof(struct edge_data),
      sizeof(struct edge_data), &data_wrapper.offset, shared_region);

  memcpy(
      (void*)(shared_region->shared_start + sizeof(struct edge_call) + sizeof(struct edge_data)),
      ptr, size);

  memcpy(
      (void*)(shared_region->shared_start + sizeof(struct edge_call)), &data_wrapper,
