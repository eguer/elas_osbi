                          ...
                          uintptr_t* user_max_seen)
{
  ...
  epm_start = pmp_region_get_addr(encl->epm.pmp_rid);
  epm_size = pmp_region_get_size(encl->epm.pmp_rid);
  utm_start = pmp_region_get_addr(encl->utm.pmp_rid);
  utm_size = pmp_region_get_size(encl->utm.pmp_rid);
